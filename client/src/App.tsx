        ...
        <div className="flex items-center gap-3">
          ...
          <div className="relative group">
            {user ? (
              ...
              // Sign in Button
              <button className="flex items-center gap-2" onClick={loginWithGitHub}>
                <img
                  src="/githubicon.png"
                  alt="Logo"
                  className="w-4 h-4"
      ...
      <footer className="h-7 bg-white dark:bg-[#010409] border-t border-gray-300 dark:border-[#30363d] flex items-center justify-between px-4 text-[11px] text-gray-600 dark:text-[#8b949e] shrink-0">
        ...
        <div className="flex items-center gap-4">
          <a
            ...
            className="flex items-center gap-1 hover:text-blue-500 dark:hover:text-[#58a6ff] transition-colors">
            <img
              src="/githubicon.png"
              alt="Logo"
