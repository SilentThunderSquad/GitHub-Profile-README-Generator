 ...
 */
export const generateMarkdownFromBlocks = (blocks) => {
    let markdown = '';
        ...
        switch (block.type) {
            ...
            case 'skills':
                ...
                if (block.data.skills && Array.isArray(block.data.skills)) {
                    block.data.skills.forEach((skill) => {
            ...
            case 'projects':
                ...
                if (block.data.projects && Array.isArray(block.data.projects)) {
                    block.data.projects.forEach((project) => {
            ...
            case 'badges':
                ...
                if (block.data.badges && Array.isArray(block.data.badges)) {
                    block.data.badges.forEach((badge) => {
                        if (badge.url) {
 ...
 */
export const generateAndSaveMarkdown = async (readmeId, blocks, userId) => {
 ...
 */
export const getMarkdownForReadme = async (readmeId, userId) => {
 ...
 */
export const exportReadmeAsMarkdown = async (readmeId, userId) => {
    const { data: readme, error } = await supabase
        .from('readmes')
