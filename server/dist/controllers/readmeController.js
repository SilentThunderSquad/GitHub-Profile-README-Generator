 ...
 * Create a new README
 */
export const createReadme = asyncHandler(async (req, res) => {
 ...
 * Get README by ID
 */
export const getReadme = asyncHandler(async (req, res) => {
    const { id } = req.params;
 ...
 * Update README
 */
export const updateReadme = asyncHandler(async (req, res) => {
    const { id } = req.params;
 ...
 * Delete README
 */
export const deleteReadme = asyncHandler(async (req, res) => {
    const { id } = req.params;
 ...
 * Get user's READMEs
 */
export const getUserReadmes = asyncHandler(async (req, res) => {
 ...
 * Clone README
 */
export const cloneReadme = asyncHandler(async (req, res) => {
    const { id } = req.params;
 ...
 * Get clone details
 */
export const getCloneDetails = asyncHandler(async (req, res) => {
    const { id } = req.params;
 ...
 * Publish README
 */
export const publishReadme = asyncHandler(async (req, res) => {
    const { id } = req.params;
 ...
 * Autosave README
 */
export const autosaveReadme = asyncHandler(async (req, res) => {
    const { id } = req.params;
 ...
 */
export const getMarkdown = asyncHandler(async (req, res) => {
    const { id } = req.params;
 ...
 */
export const exportReadme = asyncHandler(async (req, res) => {
    const { id } = req.params;
 ...
 * Like README
 */
export const likeReadme = asyncHandler(async (req, res) => {
    const { id } = req.params;
 ...
 * Unlike README
 */
export const unlikeReadme = asyncHandler(async (req, res) => {
    const { id } = req.params;
 ...
 * Get like details
 */
export const getLikeDetails = asyncHandler(async (req, res) => {
    const { id } = req.params;
...
//# sourceMappingURL=readmeController.js.map