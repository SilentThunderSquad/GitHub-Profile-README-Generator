 ...
 * Like a README
 */
export const likeReadme = async (readmeId: string, userId: string) => {
 ...
 * Unlike a README
 */
export const unlikeReadme = async (readmeId: string, userId: string) => {
 ...
 */
export const hasUserLikedReadme = async (readmeId: string, userId: string): Promise<boolean> => {
 ...
 */
export const getLikeCount = async (readmeId: string): Promise<number> => {
 ...
 */
export const getRecentLikers = async (readmeId: string, limit = 10) => {
  const { data, error } = await supabase
    .from('readme_likes')
    .select(`
      created_at,
